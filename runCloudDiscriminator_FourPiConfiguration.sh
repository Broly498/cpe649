...
sudo nice -n -20 sudo taskset 0x8 ./$POWER_MEASUREMENT_DIRECTORY/profiler -p -t 10 > $PI_HAT_POWER_MEASUREMENTS_OUTPUT_DIRECTORY/${current_time}_CloudDiscriminatorPiHatResuls.csv & sleep $PROFILER_IDLE_TIME_s
